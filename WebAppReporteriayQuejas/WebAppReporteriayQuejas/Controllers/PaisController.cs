...
namespace WebAppReporteriayQuejas.Controllers
{
    public class PaisController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id_Pais,Pais_Perteneciente")] Pais pais)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_Pais,Pais_Perteneciente")] Pais pais)
        {
            if (ModelState.IsValid)
            {
